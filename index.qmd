...
MES75PopUp <- paste0(MassEnviroScreen75$NAME, "<br/>",
                     ...
                     "<b>MA EJ Pop? </b>", MassEnviroScreen75$EJ,"<br/>",
                      ...
                      MassEnviroScreen75$popMHI, if_else(!is.na(MassEnviroScreen75$medHHincE), paste0("$",formatC(MassEnviroScreen75$medHHincE, format = "d", big.mark=",")), "NA"),"<br/>",
                      MassEnviroScreen75$popLEP, paste0(round(MassEnviroScreen75$limitEngpctE,1)),"%", "<br/>",
                     MassEnviroScreen75$popLAR, MassEnviroScreen75$LARName, "<br/>",
...
MAEJpopup <- paste0(MA_EJ23$NAME, "<br/>",
                     ...
                     "<b>MA EJ Pop? </b>", MA_EJ23$EJ,"<br/>",
                      ...
                      MA_EJ23$popMHI, if_else(!is.na(MA_EJ23$medHHincE), paste0("$",formatC(MA_EJ23$medHHincE, format = "d", big.mark=",")), "NA"),"<br/>",
                      MA_EJ23$popLEP, paste0(round(MA_EJ23$limitEngpctE,1)),"%", "<br/>",
                     MA_EJ23$popLAR, MA_EJ23$LARName, "<br/>",
                     "<b>Health Indicators (% of State Avg):</b>", "<br/>",
...
MESscorePopup <- paste0(MassEnviroScreen$NAME, "<br/>",
                     ...
                     "<b>MA EJ Pop? </b>", MassEnviroScreen$EJ,"<br/>",
                      ...
                      MassEnviroScreen$popMHI, if_else(!is.na(MassEnviroScreen$medHHincE), paste0("$",formatC(MassEnviroScreen$medHHincE, format = "d", big.mark=",")), "NA"),"<br/>",
                      MassEnviroScreen$popLEP, paste0(round(MassEnviroScreen$limitEngpctE,1)),"%", "<br/>",
                     MassEnviroScreen$popLAR, MassEnviroScreen$LARName, "<br/>",
                     "<b>Health Indicators (% of State Avg):</b>", "<br/>",
...
The MassEnviroScreen score model is computed from 30 statewide environmental, socioeconomic, and health indicators. These indicators are listed in @tbl-indicators below. Details and data sources for model indicators can be found in the [MassEnviroScreen Documentation](MassEnviroScreenDocumentation.pdf).
...
# create the table
data.frame(Indicator = c("MassEnviroScreen Score > 75", "Median Household Income",
                         "Limited English Households", "Tribal Territory", "Pediatric Asthma", 
                         "Low Birthweight", "Elevated Blood Lead Levels", "Premature Mortality", 
                         "Coronary Heart Disease", "Ozone", "PM25"),
                   `Block Groups` = c(MES75s, MHHIs, LEPs, LARs, Asthmas, LBWs, BLLs, PMRs, CHDs,
                                      OZONEs, PM25s)) %>% 
  ...
  kable(caption = "Criteria for Unfairly Burdened Areas", 
        col.names = c("UBA Criteria", "Number of Block Groups", "Pct of UBAs", "Pct of State Block Groups")) %>% 
...
Although MassEnviroScreen identifies a smaller number of census block groups, there is considerable overlap between communities meeting the state's current environmental justice population definition and the criteria for Unfairly Burdened Areas. Although `{r} round(nrow(MassEnviroScreen[MassEnviroScreen$MassEnviroScore >= 75|MassEnviroScreen$medHHincMAPCT<=65|MassEnviroScreen$limitEngpctE>=25|MassEnviroScreen$LARName != "None",])/nrow(MassEnviroScreen)*100,1)`% of census block groups in the state meet the criteria for Unfairly Burdened Areas, `{r}  round(nrow(MassEnviroScreen[(MassEnviroScreen$MassEnviroScore >= 75|MassEnviroScreen$medHHincMAPCT<=65|MassEnviroScreen$limitEngpctE>=25|MassEnviroScreen$LARName != "None") & MassEnviroScreen$EJ=="Yes",])/nrow(MassEnviroScreen[MassEnviroScreen$EJ=="Yes",])*100,1)`% of block groups defined as environmental justice populations also meet the Unfairly Burdened Areas criteria. @fig-EJoverlap shows the degree of overlap between the various criteria of environmental justice populations and Unfairly Burdened Areas. There is 100% overlap with all state Environmental Justice Population criteria save for the Minority-only category. Only 30% of census block groups defined as a Environmental Justice Population based solely on the Minority criterion (i.e., 40% or more minority) overlap with Unfairly Burdened Areas as defined here.
...
MassEnviroScreen %>% 
  ...
  geom_col() +
  coord_flip() +
  labs(title = "MA EJ Population Criteria Overlap with\nMassEnviroScreen Unfairly Burdened Areas", caption = "Based on percentage of EJ census block groups") +
  xlab("") + ylab("") +
