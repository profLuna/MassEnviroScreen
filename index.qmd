...
# create the table
data.frame(Indicator = c("MassEnviroScreen Score > 75%tile", "Median Household Income < 65% MA",
                         "Limited English Households > 25%", "Tribal Territory", 
                         "Pediatric Asthma > 200% MA", "Low Birthweight > 200% MA", 
                         "Elevated Blood Lead Levels > 200% MA", "Premature Mortality > 200% MA",                          "Coronary Heart Disease > 200% MA", "Ozone > 200% MA", 
                         "PM25 > 200% MA"),
  ...
  kable(caption = "Criteria for Unfairly Burdened Areas", 
        col.names = c("UBA Criteria", "Number of Block Groups", "Pct of UBAs", 
