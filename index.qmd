...
# create Unfairly Burdened Areas layer from MassEnviroScreen scores
...
-   Uses 28 statewide indicators to characterize both Pollution and Climate Burden and Population Characteristics
...
The MassEnviroScreen score model is computed from 28 statewide environmental, socioeconomic, and health indicators. These indicators are listed in @tbl-indicators below. Details and data sources for model indicators can be found in the [MassEnviroScreen Documentation](MassEnviroScreenDocumentation.pdf).
