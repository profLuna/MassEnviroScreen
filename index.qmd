...
To define "Burdened Areas" in this tool, cumulative burden percentile scores of 75 or higher are combined with one of the [existing Massachusetts EJ criteria](https://www.mass.gov/info-details/environmental-justice-populations-in-massachusetts) -  low income - as well as an average of four sentinel health indicators that equal or exceed 150% of the statewide average.
...
-   average of four health indicators (pediatric asthma, low birth weight, elevated blood lead levels, and premature mortality) equal or exceed 150% of the statewide average
:::
...
MassEnviroScreen <- readRDS("MassEnviroScreen.rds") %>% 
  select(UBA, EJ, EJ_CRIT_DESC, MassEnviroScore, NAME, COSUB, 
         ...
         minorityPctE, medHHincE, medHHincMAPCT, HealthPctStAvg, limitEngpctE, LARName, 
...
-   MassEnviroScreen defines "Burdened Areas" based on a cumulative burden score that integrates demographic criteria, health status, and environmental conditions across 30 indicators, OR percent of households below 65% of statewide median household income, OR average percent of key health indicators equals or exceeds 150% of the statewide average.
...
data.frame(Indicator = c("MassEnviroScreen Score >= 75%tile", 
                   ...
                   `Block Groups` = c(MES75s, MHHIs, HLTH)) %>% 
